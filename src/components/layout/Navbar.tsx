      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-10">
            <Link
              href="/collections"
              className={`font-display text-sm uppercase tracking-[0.15em] font-extrabold transition-colors hover:text-gold-600 ${
                isSelected("/collections") ? "text-gold-700 font-black" : "text-neutral-700"
              }`}
            >
              Browse Products
            </Link>
          ...
          <div className="text-center absolute left-1/2 transform -translate-x-1/2 md:static md:transform-none">
            <Link href="/" className="flex flex-col items-center">
              <span className="font-display text-lg sm:text-xl tracking-[0.3em] uppercase font-bold text-neutral-950">
                MAISON L'ÉTOILE
              </span>
              <span className="font-serif text-[9px] tracking-[0.3em] text-gold-600 uppercase mt-0.5">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            {user && user.role === "admin" && (
              <Link
                href="/admin"
                className={`text-neutral-700 hover:text-neutral-950 p-2 focus:outline-none relative transition-colors ${
